...
*/
Philipps::Philipps(const double p_wind_speed, const int p_wind_alignment, const double p_min_wave_size, const double p_A, const double p_lx, const double p_ly, const int p_nx, const int p_ny) :
